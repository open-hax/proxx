...
export function loadConfig(cwd: string = process.cwd()): ProxyConfig {
  ...
  return {
    ...
    keyCooldownJitterFactor: nonNegativeNumberFromEnvAliases(["PROXY_KEY_COOLDOWN_JITTER_FACTOR"], 0.2),
    enableKeyRandomWalk: booleanFromEnvAliases(["ENABLE_KEY_RANDOM_WALK"], true),
